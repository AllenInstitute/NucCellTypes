...
all.paths <- paste0(root.path,
                    c("/rnaseqanalysis/shiny/facs_seq/mouse_V1_ALM_20170905_exons_introns/", 
                      ...
                      "/rnaseqanalysis/shiny/facs_seq/mouse_V1_ALM_20170913/",
...
names(all.paths) <- c("Mouse_V1_ALM", "Mouse_V1_ALM_0405", "Mouse_V1_ALM_0913",
                      "Mouse_Nuc",
                      "Mouse_L5_Nuc", "Mouse_L5_Cell", 
                      "Mouse_L5_Snap25", "Mouse_L5_Nuc_Ex",
                      "Mouse_V1_Tasic",
                      "Human_VISp_AIBS_1023")
paths <- all.paths[c("Mouse_Nuc", "Human_VISp_AIBS_1023")]
...
for (dat1 in names(paths)) {
  ...
  } else if (dat1 == "Human_VISp_AIBS_1023") {
    keep.cl <- unlist(dendrapply(dend[[dat1]], function(x) if (is.leaf(x)) attr(x, "label")))
...
for (dat1 in names(paths)) {
  pdf(file = paste0("../output/", dat1, "_tree.pdf"), 
       width = 4, height = 4)
